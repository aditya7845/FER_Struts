...
public class FERServiceImpl implements FERService {
	...
	@Override
	public boolean login(String usernamre, String password, Connection connection) {
	...
	public boolean registration(User user, Connection connection) {
		...
		try {
			...
			preparedStatement = connection
					.prepareStatement("insert into user (firstname, middlename, lastname, emailid, username, password, mobile) values(?,?,?,?,?,?,?)");
	...
	@Override
	public boolean addExpense(Expense expense,Connection connection) {
		//Connection connection = null;
		...
		try {
			//connection = DBUtil.getConnection();
			p = connection
					.prepareStatement("insert into expense(expensetype, date, price, numberofitems, total, bywhom, remarks) values(?,?,?,?,?,?,?)");
	...
	@Override
	public boolean deleteExpense(int id,Connection connection) {
		//Connection connection = null;
		PreparedStatement p = null;
	...
	@Override
	public boolean editExpense(Expense expense,Connection connection) {
		//Connection connection = null;
		PreparedStatement p = null;
		...
		try {
			...
			p = connection
					.prepareStatement("update expense set expensetype=?, date=?, price=?, numberofitems=?, total=?, bywhom=?, remarks=? where id=?");
	...
	public Expense getExpense(int expenseid) {
		...
		try {
			...
			while (resultset.next()) {
				...
				expensseObject.setExpensetype(resultset
						.getString("expenseType"));
				expensseObject.setPrice(resultset.getInt("price"));
				expensseObject.setNumberofitems(resultset
	...
	@Override
	public List<Expense> getExpenseReport(String expensetype, String fromdate,
			String todate) {
		Connection connection = null;
		PreparedStatement p = null;
		...
		try {
			connection = DBUtil.getConnection();
			p = connection
					.prepareStatement("select * from expense where expensetype=? and date between ? and ? ");
	...
	public List<Expense> getExpenses() {
		...
		try {
			...
			while (resultset.next()) {
				...
				System.out.println(expense.getExpensetype() + expense.getDate()
						+ expense.getPrice() + expense.getNumberofitems()
						+ expense.getTotal() + expense.getBywhom()
						+ expense.getId() + expense.getRemarks());
	...
	@Override
	public boolean resetPassword(String username, String currentpassword,
			String newPassword) {
		Connection connection = null;
		PreparedStatement p = null;
	...
	@Override
	public boolean uppdatePersonalInfo(User user, Address address) {
		Connection connection = null;
		PreparedStatement p = null;
		...
		try {
			...
			p = connection
					.prepareStatement("Update user set firstname=?, middlename=?, lastname=?, emailid=?, mobile=? where id=?");
